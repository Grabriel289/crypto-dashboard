...
#
# Each entry: coin → { "binance"|"okx"|"bybit"|"kucoin": ticker | None }
# None (or absent) means the coin is not available on that exchange.
# Fallback order: Binance → OKX → Bybit → KuCoin
# ---------------------------------------------------------------------------
ABM_UNIVERSE = {
    ...
    "XMR":    {"binance": None,          "okx": None, "kucoin": "XMR-USDT"},
    ...
    # Tier C — newer but confirmed (2022-2023)
    "MNT":    {"binance": "MNTUSDT",    "okx": "MNT-USDT"},
    "TAO":    {"binance": "TAOUSDT",    "okx": "TAO-USDT"},
    "ASTER":  {"binance": "ASTERUSDT",  "okx": None},
    "SKY":    {"binance": "SKYUSDT",    "okx": "SKY-USDT"},
    ...
    # Tier D — 2024+
    "WLFI":   {"binance": "WLFIUSDT",   "okx": None},
    ...
    "AERO":   {"binance": None,          "okx": None, "kucoin": "AERO-USDT"},
    "SPX":    {"binance": None,          "okx": None, "kucoin": "SPX-USDT"},
    "IP":     {"binance": None,          "okx": "IP-USDT"},
    "MON":    {"binance": None,          "okx": None, "bybit": "MONUSDT"},
}

# BTC is the benchmark — fetched separately
BTC_SYMBOL = {"binance": "BTCUSDT", "okx": "BTC-USDT"}

# Binance / OKX / Bybit / KuCoin base URLs
